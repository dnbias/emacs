;;; themes/rougee-theme.el -*- lexical-binding: t; -*-
(require 'doom-themes)
...
(def-doom-theme rougee
  "A dark theme ported from VS Code's Rouge. And then modified."

  ;; name        default   256       16
  ((bg         '("#111116" nil       nil            )) ;; modified, more black now
   (bg-alt     '("#111116" nil       nil            ))
   (base0      '("#070A0E" "black"   "black"        ))
   (base1      '("#111116" "#1e1e1e" "brightblack"  ))
  ...
  (((font-lock-comment-face &override)
   ...
   ;;;; consult
   (consult-preview-match :background (doom-lighten bg 0.1))
   ;;;; vertico
